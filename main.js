...
function showGrid(userChoice) {
  ...
  for (let i = 0; i < gridDimension * gridDimension; i++) {
    ...
    newDiv.setAttribute("style", `border: 0.5px black solid; width: ${individualSquare}; height: ${individualSquare}; box-sizing: border-box;`);    containerDiv.appendChild(newDiv);
    // add event listener
